...
// Added standard tracking function (assumes dataLayer exists via GTM/GA4 snippet in layout)
import { trackConversion } from "@/utils/analytics"; // Adjust path as needed

export default function StickyCTA() {

  // Handlers for the required GA4 conversion events (Section G2, Task 10)
  const handleCallClick = () => {
    trackConversion('click_to_call', { source: 'mobile_sticky_bar' });
  };

  const handleOrderClick = () => {
    trackConversion('click_order_now', { source: 'mobile_sticky_bar' });
  };
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] md:hidden pb-safe">
      <div className="bg-black/80 backdrop-blur-xl border-t border-white/10 px-4 py-4 flex gap-3 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        ...
        <a
          href="tel:0533002270"
          onClick={handleCallClick} // ADDED: Conversion tracking
        ...
        <Link
          href="/order"
          onClick={handleOrderClick} // ADDED: Conversion tracking
