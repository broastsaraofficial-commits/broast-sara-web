      ...
      sections: [
        {
          ...
          body: "يبدأ سحر شاورما الصاروخ من الغلاف الخارجي. نحن نستخدم خبز الصاج الرقيق والطازج بدلاً من الخبز العادي. هذا الخبز يتميز بقدرته على التحميص بشكل مثالي ليمنحك قرمشة خفيفة مع كل قضمة، دون أن يكون سميكاً لدرجة تطغى على طعم الحشوة الداخلية."
        },
        {
