...
// Your EXACT branch data - No changes made to content
const branches = {
    "al-aziziyyah": { ar: "العزيزية", en: "Al Aziziyyah", phone: "0596624929", addressAr: "حي العزيزية، المدينة المنورة", addressEn: "Al Aziziyyah, Madinah 42376", lat: "24.4686", lng: "39.6142" },
    "al-hijrah": { ar: "الهجرة", en: "Al Hijrah", phone: "0553793829", addressAr: "شارع الأمير سلطان، الهجرة، حي الشيبية", addressEn: "Prince Sultan Street, Al Hijrah, Madinah 42392", lat: "24.4321", lng: "39.5987" },
    "imam-bukhari": { ar: "الإمام البخاري", en: "Imam Bukhari", phone: "0533107787", addressAr: "الضيافة، المدينة المنورة", addressEn: "Al Imam Al Boukhari, Ad Difa, Madinah 42374", lat: "24.4812", lng: "39.5634" },
    "hil-bahr": { ar: "حي البحر", en: "Hil Bahr", phone: "0533002270", addressAr: "الجمعة، المدينة المنورة", addressEn: "Jaber Ibn Atik, Al Jumuah, Madinah 42316", lat: "24.4501", lng: "39.6200" },
    "aljwazat": { ar: "الجوازات", en: "Aljwazat", phone: "0540414841", addressAr: "الروابي، المدينة المنورة", addressEn: "Ar Rawabi, Madinah 42381", lat: "24.4600", lng: "39.6300" },
    "al-juruf": { ar: "الجرف", en: "Al Juruf", phone: "0551624234", addressAr: "الزهراء، المدينة المنورة", addressEn: "Az Zahrah, Madinah 42334", lat: "24.4900", lng: "39.5800" },
    "yanbu": { ar: "ينبع", en: "Yanbu", phone: "0500978585", addressAr: "عمر بن الخطاب، العمارة، ينبع", addressEn: "Omar Bin Al Khattab, Al Amarah, Yanbu 46421", lat: "24.0891", lng: "38.0622" },
    "abiar-al-mashi": { ar: "أبيار الماشي", en: "Abiar Al Mashi", phone: "0530957742", addressAr: "حي أبيار الماشي، المدينة المنورة", addressEn: "Abiar Al Mashi, Madinah 42542", lat: "24.3100", lng: "39.5100" }
};

// CRITICAL FIX: Generates static routes for BOTH languages to prevent 404s
...
export default async function BranchPage({ params }) {
    ...
    // MANDATORY: Section D3 LocalBusiness Schema
    const jsonLd = {
        "@context": "https://schema.org",
        "@type": "Restaurant",
        "name": isEn ? `Broast Sara — ${branch.en}` : `بروست سارة — فرع ${branch.ar}`,
    ...
    return (
        <div className="w-full pt-40 pb-32 px-6" dir={isEn ? "ltr" : "rtl"}>
            ...
            {/* 1. FIXED: Replaced premium-card with liquid-glass to restore background */}
            <div className="max-w-5xl mx-auto liquid-glass overflow-hidden flex flex-col text-center md:text-start">
                ...
                <div className="p-12 md:p-16 flex flex-col">
                    <h1 className="text-4xl md:text-6xl mb-12 text-[#FFD700] font-instrument font-bold text-center">
                        {isEn ? `Broast Sara — ${branch.en} Branch` : `بروست سارة — فرع ${branch.ar}`}
                    </h1>
                    ...
                    <div className="flex flex-col gap-6 text-xl mb-12 text-white/90">
                        <div className="flex items-center gap-4 justify-center md:justify-start">
                            ...
                            <span className="font-helvetica tracking-[-0.05em] leading-relaxed">
                        ...
                        <div className="flex items-center gap-4 justify-center md:justify-start">
                            ...
                            <span className="font-helvetica tracking-[-0.05em]">{isEn ? 'Daily: 12:30 PM - 2:30 AM' : 'يومياً: 12:30 م - 2:30 ص'}</span>
                        </div>
                    </div>

                    {/* Action Buttons */}
                    <div className="flex flex-col md:flex-row gap-6 justify-center pb-6">
